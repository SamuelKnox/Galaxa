...
void SpriteDemoManagerC::renderSprites()
{
	...
	GLfloat width = 648.0f;
	GLfloat height = 428.0f;

	glBegin(GL_QUADS);
	glColor4ub(0xFF, 0xFF, 0xFF, 0xFF);
	/*glTexCoord2f(xTextureCoord, yTextureCoord);									glVertex3f(xPositionLeft, yPositionTop, 0.0);
	glTexCoord2f(xTextureCoord + (1.0f / 8.0f), yTextureCoord);					glVertex3f(xPositionRight, yPositionTop, 0.0);
	glTexCoord2f(xTextureCoord + (1.0 / 8.0f), yTextureCoord + (1.0 / 4.0f));	glVertex3f(xPositionRight, yPositionBottom, 0.0);
	glTexCoord2f(xTextureCoord, yTextureCoord + (1.0 / 4.0f));					glVertex3f(xPositionLeft, yPositionBottom, 0.0);*/
