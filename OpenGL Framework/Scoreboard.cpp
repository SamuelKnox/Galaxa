...
{
	label = new Sprite(-3 * DIGIT_SEPARATION, SCOREBOARD_Y, HIGH_SCORE_WIDTH, HIGH_SCORE_HEIGHT, SpriteManager::LABEL);
	score = 0;
	for (int32_t i = 0; i < NUM_LINES / 7; i++) {
		lines[0 + i * 7] = new Sprite(SCOREBOARD_X + SCOREBOARD_HORIZONTAL_WIDTH / 2 - DIGIT_SEPARATION * i, SCOREBOARD_Y - SCOREBOARD_HORIZONTAL_HEIGHT / 2, SCOREBOARD_HORIZONTAL_WIDTH, SCOREBOARD_HORIZONTAL_HEIGHT, SpriteManager::HLINE);
		...
		lines[3 + i * 7] = new Sprite(SCOREBOARD_X + SCOREBOARD_HORIZONTAL_WIDTH / 2 - DIGIT_SEPARATION * i, SCOREBOARD_Y - SCOREBOARD_HORIZONTAL_HEIGHT / 2 - SCOREBOARD_VERTICAL_HEIGHT, SCOREBOARD_HORIZONTAL_WIDTH, SCOREBOARD_HORIZONTAL_HEIGHT, SpriteManager::HLINE);
		...
		lines[6 + i * 7] = new Sprite(SCOREBOARD_X + SCOREBOARD_HORIZONTAL_WIDTH / 2 - DIGIT_SEPARATION * i, SCOREBOARD_Y - SCOREBOARD_HORIZONTAL_HEIGHT / 2 - SCOREBOARD_VERTICAL_HEIGHT * 2, SCOREBOARD_HORIZONTAL_WIDTH, SCOREBOARD_HORIZONTAL_HEIGHT, SpriteManager::HLINE);
	}	
}
